...
def circle_line_segment_intersection(
    ...
    Note:
        Credit: http://mathworld.wolfram.com/Circle-LineIntersection.html, https://stackoverflow.com/a/59582674/9173068
    """
...
def iterative_line_interpolation(
    ...
    # Overwritten in the loop before use.
    ...
    while (
        ...
        < config.policy.transfuser.num_route_points_smoothing
    ):
