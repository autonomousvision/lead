"""Lateral planning for the expert: reshaping the route around obstacles.

Handles scenarios that require leaving the planned lane (accidents,
construction sites, parked obstacles, two-way overtaking, yielding to
emergency vehicles) by shifting the privileged route and deciding when the
opposite lane is free for overtaking.
"""
...
from lead.lead.planning.speed_planning import (
...
class PathPlanningMixin:
    """Route reshaping, mixed into :class:`lead.lead.expert.Expert`."""
