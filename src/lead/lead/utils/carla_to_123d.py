...
Handles coordinate-system conversions between CARLA (Unreal Engine, left-handed,
+y right) and ISO 8855 (py123d, right-handed, +y left), plus the static sensor
and vehicle metadata used to describe the LEAD sensor rig in 123D logs.
"""
...
def get_actor_bounding_box_se3(
    ...
    if overwrite_extent is None:
        ...
        extent_list = list(overwrite_extent)
