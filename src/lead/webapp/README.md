...
1. **Select a route** from the sidebar to view its infractions
1. **Click any infraction** in the list to jump to that timestamp in the video
1. Use **video controls** for playback speed and frame-by-frame navigation
