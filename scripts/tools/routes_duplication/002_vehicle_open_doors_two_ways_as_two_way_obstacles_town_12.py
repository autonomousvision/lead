...
# Ranges
FREQ_FROM_MIN, FREQ_FROM_MAX = 40, 70
FREQ_TO_MIN, FREQ_TO_MAX = 110, 170
...
def main():
    ...
    for town, town_path in [("Town12", "50x38_Town12"), ("Town13", "50x36_Town13")]:
        for tgt_scenario in ["ConstructionObstacleTwoWays", "AccidentTwoWays"]:
            src_route_dir = f"data/routes/{town_path}/VehicleOpensDoorTwoWays"
            src_scenario = "VehicleOpensDoorTwoWays"
