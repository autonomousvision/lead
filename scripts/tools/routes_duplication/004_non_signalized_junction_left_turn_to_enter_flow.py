...
def main():
    ...
    for town, town_path in [("Town12", "50x38_Town12"), ("Town13", "50x36_Town13")]:
        src_route_dir = f"data/routes/{town_path}/NonSignalizedJunctionLeftTurn"
        src_scenario = "NonSignalizedJunctionLeftTurn"
        tgt_scenario = "NonSignalizedJunctionLeftTurnEnterFlow"
