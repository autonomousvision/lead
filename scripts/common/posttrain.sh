...
export LEAD_CONFIG="training.experiment.logdir=$LEAD_OUTPUT_DIR_ROOT/local_training/posttrain \
training.experiment.load_file=$LEAD_OUTPUT_DIR_ROOT/local_training/pretrain/model_0030.pth \
