...
def make_bash(bash_file, route_file, route_id, args):
    ...
    bench2drive_evaluator = "3rd_party/leaderboard/bench2drive/leaderboard/leaderboard/leaderboard_evaluator.py"
    fail2drive_evaluator = "3rd_party/leaderboard/fail2drive/leaderboard/leaderboard/leaderboard_evaluator.py"
    standard_evaluator = "3rd_party/leaderboard/standard/leaderboard/leaderboard/leaderboard_evaluator.py"
...
if [[ $EVALUATION_DATASET == "bench2drive" ]]; then
    ...
    export LEADERBOARD_ROOT=3rd_party/leaderboard/fail2drive/leaderboard
    export CARLA_ROOT={REPO_ROOT}/3rd_party/CARLA/fail2drive_0915
else
    export IS_BENCH2DRIVE=0
...
def main():
    ...
    route_files: list[str] = glob.glob(
        os.path.join(REPO_ROOT, args.route_folder, "**", "*.xml"),
        recursive=True,
    )
