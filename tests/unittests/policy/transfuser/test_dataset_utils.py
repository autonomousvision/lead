...
class TestRasterizeLidar:
    ...
    def test_rasterize_multiple_points(self, config):
        ...
        z = np.random.uniform(
            config.expert.storage.min_height_lidar,
            config.expert.storage.max_height_lidar,
            n_points,
        )
        ...
        lidar = np.array(
            [
                ...
                [
                    1.0,
                    1.0,
                    config.expert.storage.max_height_lidar + 1.0,
                ],  # Above max
                [
                    2.0,
                    2.0,
                    config.expert.storage.min_height_lidar - 1.0,
                ],  # Below min
